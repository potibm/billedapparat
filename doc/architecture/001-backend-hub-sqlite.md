...
- **Process Isolation:** Collectors are _not_ automatically spawned or managed by the Hub's main server process. Each collector runs as an entirely independent OS process (or container).
