...
Instead of hardcoding sequences or building separate apps for different screen setups, we "embraced" the open physical decision. A Playlist is defined in the system's configuration and dictates a sequence of "Steps" based purely on content _types_ (e.g., "sponsor", "social.media", "news").
